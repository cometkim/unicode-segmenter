...
Pure JavaScript library to split grapheme clusters in unicode string.

> [!INFO]
> The initial implementation was ported manually from Rust's [unicode-segmentation] library.
