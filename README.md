...
| `unicode-segmenter/grapheme` (full*) | 17.0.0   | ✔️   |  10,492 |      5,781 |           2,738 |         2,450 |           2,800 |
...
|-------------------------------------|--------------:|----------------------:|
| `unicode-segmenter/grapheme`        |        20,019 |                11,068 |
| `unicode-segmenter/grapheme` (full) |        20,224 |                11,206 |
