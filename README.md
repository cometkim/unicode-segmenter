...
|--------------------------------------|----------|------|--------:|-----------:|----------------:|--------------:|----------------:|
| `unicode-segmenter/grapheme`         | 17.0.0   | ✔️   |   8,782 |      5,069 |           2,462 |         2,210 |           2,508 |
| `unicode-segmenter/grapheme` (full*) | 17.0.0   | ✔️   |  11,020 |      5,859 |           2,687 |         2,387 |           2,726 |
...
|-------------------------------------|--------------:|----------------------:|
| `unicode-segmenter/grapheme`        |        19,957 |                11,184 |
| `unicode-segmenter/grapheme` (full) |        20,162 |                11,309 |
