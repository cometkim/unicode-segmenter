...
|--------------------------------------|----------|------|--------:|-----------:|----------------:|--------------:|----------------:|
| `unicode-segmenter/grapheme`         | 17.0.0   | ✔️   |   7,752 |      4,866 |           2,321 |         2,104 |           2,371 |
| `unicode-segmenter/grapheme` (full*) | 17.0.0   | ✔️   |  10,158 |      5,715 |           2,605 |         2,323 |           2,666 |
...
|-------------------------------------|--------------:|----------------------:|
| `unicode-segmenter/grapheme`        |        15,782 |                 8,914 |
| `unicode-segmenter/grapheme` (full) |        15,987 |                 9,076 |
