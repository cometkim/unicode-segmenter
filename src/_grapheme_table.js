...
export const grapheme_ranges = initUnicodeRangeBuffer(
...
export const grapheme_cats = initLookupTableBuffer(
  new Uint8Array(1454),
...
export function findGraphemeIndex(cp) {
  ...
  return bsearchUnicodeRange(cp, grapheme_ranges, sliceFrom * 2, sliceTo * 2);
}
