...
export const grapheme_ranges = createRangeTable(
...
export const grapheme_cats = createTable(
  new Uint8Array(1454),
...
/**
 * @param {number} cp
 * @return An {@link GraphemeCategoryRange} if found, or approx `start` and `padding` values with {@link GC_Any} category.
 */
export function findGraphemeIndex(cp) {
  ...
  return bsearchRange(cp, grapheme_ranges, sliceFrom * 2, sliceTo * 2);
}
