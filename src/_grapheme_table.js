...
export const grapheme_range_table = createRangeTable(
...
export const grapheme_cat_table = createTable(
  new Uint8Array(1454),
...
export function searchGraphemeIndex(cp) {
  ...
  if (idx + 1 < 1024) {
    sliceFrom = grapheme_lookup_table[idx];
    sliceTo = grapheme_lookup_table[idx + 1] + 1;
  }

  return bsearchRange(cp, grapheme_range_table, sliceFrom * 2, sliceTo * 2);
}
